...
from diffusers.models.attention import Attention, BasicTransformerBlock, FeedForward, _chunked_feed_forward
from diffusers.models.embeddings import CombinedTimestepLabelEmbeddings, LabelEmbedding, PatchEmbed, TimestepEmbedding, Timesteps
from diffusers.models.modeling_utils import ModelMixin
from diffusers.models.normalization import AdaLayerNormZero

from .diffusers import autocast_patch
from .registry import register_model
from .utils import constant_init, get_root_logger, kaiming_init, load_checkpoint, rgetattr, xavier_init
...
class BasicTransformerBlockMod(BasicTransformerBlock):
    ...
    def forward(
            ...
            added_cond_kwargs: dict[str, torch.Tensor] | None = None) -> torch.Tensor:
...
@register_model("GMDiTTransformer2DModel")
